...
namespace MvcBookStore.Controllers.Api
{
    public class AuthorsController : ApiController
    {
        ...
        // GET: api/Authors
        public ResultList<AuthorViewModel> GetAuthors([FromUri] QueryOption queryOption)
        {
            var start = (queryOption.CurrentPage - 1) * queryOption.PageSize;
            ...
            var viewModels = authors.ToList()
                .Select(author => Mapper.Map<Author, AuthorViewModel>(author))
                .ToList();
